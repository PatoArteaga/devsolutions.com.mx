...
-- Tiempo de generación: 25-03-2026 a las 03:56:15
...
INSERT INTO `coordinador` (`id_cordinador`, `id_usuario`) VALUES
(10, 144),
(11, 145),
(12, 146);
...
CREATE TABLE `promovidos` (
  ...
  `abierto` varchar(50) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  ...
  `comentarios` varchar(200) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `id_cordinador` int NOT NULL,
  `id_lider` int NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `comentarios` varchar(250) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `estatus` int NOT NULL
...
INSERT INTO `usuarios` (`id_usuario`, `usuario`, `nombre`, `apellido`, `email`, `pass`, `f_creacion`, `f_modificacion`, `f_eliminacion`, `img`, `nivel`, `comentarios`, `estatus`) VALUES
(1, 'pato', 'Larry', 'Arteaga', 'larry@gmail.com', 'lala', '2025-11-13', '2025-11-13', '2025-11-14', '', 0, NULL, 1),
(3, 'admin', 'AdminAdmin', 'Admin', 'test@gmail.com', 'admin', '2025-11-01', '2025-11-01', '2025-11-01', NULL, 0, NULL, 1),
(4, 'Yesenia', 'Yesenia', 'Cordinador', 'test@gmail.com', 'lala', '2025-11-01', '2025-11-01', NULL, NULL, 1, NULL, 1),
(5, 'Marisol', 'Marisol', 'Lider', 'test@gmail.com', 'lider', '2025-11-01', '2025-11-01', NULL, NULL, 2, NULL, 1),
(7, 'rosio', 'Rosio', 'Lider', 'test@gmail.com', 'lala', '2026-01-01', NULL, NULL, NULL, 2, NULL, 1),
(143, 'lala', 'Larry', 'Arteaga', 'lartz12.14@gmail.com', 'l', '2026-03-21', NULL, NULL, NULL, 2, NULL, 0),
(144, '1', 'Larry', 'Arteaga', 'lartz12.14@gmail.com222222', '1', '2026-03-21', NULL, NULL, NULL, 1, 'uusuariooonivel1', 1),
(145, 'Usuario1', 'Nombre1', 'Apellido1', 'test1@example.com', 'password123', '2026-03-24', NULL, NULL, NULL, 1, 'Este es un comentario.', 1),
(146, 'papa', 'Larry', 'Arteaga', 'lartz12.14@gmail.com3333', 'l', '2026-03-24', NULL, NULL, NULL, 1, 'este es un usuario de prueba', 1),
(147, 'pato', 'Larry', 'Arteaga', 'lartz12.14@gmail.comddddd', 'q', '2026-03-24', NULL, NULL, NULL, 2, 'qqqqq', 1);
...
--
ALTER TABLE `coordinador`
  MODIFY `id_cordinador` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=148;
COMMIT;
